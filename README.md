...
- Workspace UI: `ResizablePane`, `WhichKeyPopup`, `InspectorPane`, `PermissionCard`, `PromptCard`, `PermissionPrompts`, `ReactReagentSeam`, `CommandPalette`, `Chat`, `Toast`, `FileTree`, `Tabs`
